...
public class DlgTemplateResepRSMG extends javax.swing.JDialog {
    ...
    private String aktifkanparsial="no",norm="",kddokter="",kode_pj="",norawat="",status="",templateresep="dokter",nmpasien="",nmdokter="",bangsal="";
     ...
     * @param parent
     * @param modal */
    public DlgTemplateResepRSMG(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        Object[] row={"No.Resep","Tgl.Resep","Jam Resep","Nama Resep","","","Dokter Peresep","Kode Dokter"};
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),0).toString().equals("")){
                ...
                Sequel.meghapus("resep_template_rsmg","no_resep",tbPemisahan.getValueAt(tbPemisahan.getSelectedRow(),0).toString()); 
                tampil();               
            }
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTemplateResepRSMG dialog = new DlgTemplateResepRSMG(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{  
            if(templateresep.equals("dokter")){
               ...
               if(templateresep.equals("dokter")){
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        rs.getString("no_resep"),rs.getString("tgl_peresepan"),rs.getString("jam_peresepan"),rs.getString("nm_resep"),
    ...
    public void setRM(String norawat,String norm,String kodedokter,String kodepj,String status,String nmpasien){
        this.norm=norm;
        this.status=status;
    ...
    private void panggilform() {
        nmdokter=Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",kddokter);
        //Tambahan untuk bangsal ranap
        bangsal=Sequel.cariIsi("select kd_depo from set_depo_ranap where kd_bangsal=?",Sequel.cariIsi("select kd_bangsal from kamar where kd_kamar=?",Sequel.cariIsi("select kd_kamar from kamar_inap where no_rawat=?",norawat)));
        if(bangsal.equals("")){
            if(Sequel.cariIsi("select asal_stok from set_lokasi").equals("Gunakan Stok Bangsal")){
                akses.setkdbangsal(Sequel.cariIsi("select kd_bangsal from kamar where kd_kamar=?",Sequel.cariIsi("select kd_kamar from kamar_inap where no_rawat=?",norawat)));
            }else{

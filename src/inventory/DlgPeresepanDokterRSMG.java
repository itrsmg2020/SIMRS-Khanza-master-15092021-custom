...
public final class DlgPeresepanDokterRSMG extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-06-2022" }));
        ...
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {   
                ...
                if(ubah==false){
                    ...
                    Sequel.meghapus("resep_dokter_rsmg","no_resep",NoResep.getText());
                    Sequel.meghapus("resep_dokter_racikan_rsmg","no_resep",NoResep.getText());
                    Sequel.meghapus("resep_dokter_racikan_detail_rsmg","no_resep",NoResep.getText());
                    ubah=false;
                    simpandata();
                }                                                      

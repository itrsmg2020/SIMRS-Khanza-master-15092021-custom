        ...
        try{   
            ...
            try{
                ...
                if(rsreg.next()){
                    ...
                    //Tambahan Untuk Cetak Ulang Nota Tindakan Dokter
                    for(i=0;i<tbTindakanDrBayar.getRowCount();i++){
                    ...
                    //Tambahan Untuk Cetak Ulang Nota Tindakan Perawat
                    for(i=0;i<tbTindakanPrBayar.getRowCount();i++){
                    ...
                    //Tambahan Untuk Cetak Ulang Nota Tindakan Dokter Dan Perawat
                    for(i=0;i<tbTindakanDrPrBayar.getRowCount();i++){
                    ...
                    for(i=0;i<tbTindakanDrBayar.getRowCount();i++){
                        if(tbTindakanDrBayar.getValueAt(i,0).toString().equals("true")){
                            if(tbTindakanDrBayar.getValueAt(i,11).toString().equals("0000-00-00")){
                                if((!KdDok.getText().equals(""))&&(!TDokter.getText().equals(""))){
                                    ...
                                    tabModeBilling.addRow(new Object[]{
                                        "",tbTindakanDrBayar.getValueAt(i,2).toString(),":",
                                        Double.parseDouble(tbTindakanDrBayar.getValueAt(i,4).toString()),1,
                                        Double.parseDouble(tbTindakanDrBayar.getValueAt(i,4).toString()),"Ralan Dokter"
                                    });
                                }
                            }else{
                                Suspen_Tindakan_Ralan=Suspen_Tindakan_Ralan+Double.parseDouble(tbTindakanDr.getValueAt(i,4).toString());
                    ...
                    for(i=0;i<tbTindakanPrBayar.getRowCount();i++){
                        if(tbTindakanPrBayar.getValueAt(i,0).toString().equals("true")){
                            if(tbTindakanPrBayar.getValueAt(i,11).toString().equals("0000-00-00")){
                                if((!kdptg.getText().equals(""))&&(!TPerawat.getText().equals(""))){
                                    ...
                                    tabModeBilling.addRow(new Object[]{
                                        "",tbTindakanPrBayar.getValueAt(i,2).toString(),":",
                                        Double.parseDouble(tbTindakanPrBayar.getValueAt(i,4).toString()),1,
                                        Double.parseDouble(tbTindakanPrBayar.getValueAt(i,4).toString()),"Ralan Paramedis"
                                    });
                                }
                            }else{
                    ...
                    //Tambahan Untuk Cetak Ulang Nota Tindakan Dokter Perawat
                    for(i=0;i<tbTindakanDrPrBayar.getRowCount();i++){
                        if(tbTindakanDrPrBayar.getValueAt(i,0).toString().equals("true")){
                            if(tbTindakanDrPrBayar.getValueAt(i,11).toString().equals("0000-00-00")){
                                if((!kdptg2.getText().equals(""))&&(!TPerawat2.getText().equals(""))&&(!KdDok2.getText().equals(""))&&(!TDokter2.getText().equals(""))){
                                    ...
                                    tabModeBilling.addRow(new Object[]{
                                        "",tbTindakanDrPrBayar.getValueAt(i,2).toString(),":",
                                        Double.parseDouble(tbTindakanDrPrBayar.getValueAt(i,4).toString()),1,
                                        Double.parseDouble(tbTindakanDrPrBayar.getValueAt(i,4).toString()),"Ralan Dokter Paramedis"
                                    });
                                }
                            }else{
                    ...
                    //Tambahan Untuk Cetak Ulang Nota Radiologi
                    for(i=0;i<tbRadiologiBayar.getRowCount();i++){
                        if(tbRadiologiBayar.getValueAt(i,0).toString().equals("true")){
                            if(tbRadiologiBayar.getValueAt(i,11).toString().equals("0000-00-00")){
                                if((!KdDokPerujukRad.getText().equals(""))&&(!TDokterPerujukRad.getText().equals(""))){
                                    ...
                                    tabModeBilling.addRow(new Object[]{
                                        "",tbRadiologiBayar.getValueAt(i,2).toString(),":",
                                        Double.parseDouble(tbRadiologiBayar.getValueAt(i,3).toString()),1,
                                        Double.parseDouble(tbRadiologiBayar.getValueAt(i,3).toString()),"Radiologi"
                                    });
                                }
                            }else{
                                Jasa_Medik_Dokter_Radiologi_Ralan=Jasa_Medik_Dokter_Radiologi_Ralan+Double.parseDouble(tbRadiologiBayar.getValueAt(i,7).toString());
                    ...
                    //Tambahan Untuk Cetak Ulang Nota Laborat
                    for(i=0;i<tbLaboratBayar.getRowCount();i++){
                        if(tbLaboratBayar.getValueAt(i,0).toString().equals("true")){
                            if(tbLaboratBayar.getValueAt(i,11).toString().equals("0000-00-00")){
                                if((!KdDokPerujukLab.getText().equals(""))&&(!TDokterPerujukLab.getText().equals(""))){
                                    ...
                                    tabModeBilling.addRow(new Object[]{
                                        "",tbLaboratBayar.getValueAt(i,2).toString(),":",
                                        Double.parseDouble(tbLaboratBayar.getValueAt(i,3).toString()),1,
                                        Double.parseDouble(tbLaboratBayar.getValueAt(i,3).toString()),"Laborat"
                                    });
                                }
                            }else{
                                Jasa_Medik_Dokter_Laborat_Ralan=Jasa_Medik_Dokter_Laborat_Ralan+Double.parseDouble(tbLaboratBayar.getValueAt(i,7).toString());
                    ...
                    //Tambahan Untuk Cetak Ulang Nota Detail Laborat
                    for(i=0;i<tbDetailLaboratBayar.getRowCount();i++){
                        if(tbDetailLaboratBayar.getValueAt(i,0).toString().equals("true")){
                            if(tbDetailLaboratBayar.getValueAt(i,11).toString().equals("0000-00-00")){
                                if(!tbDetailLaboratBayar.getValueAt(i,1).toString().equals("")){
                                    if((!KdDokPerujukLab.getText().equals(""))&&(!TDokterPerujukLab.getText().equals(""))){
                                        ...
                                        tabModeBilling.addRow(new Object[]{
                                                ...
                                                Double.parseDouble(tbDetailLaboratBayar.getValueAt(i,3).toString()),1,
                                                Double.parseDouble(tbDetailLaboratBayar.getValueAt(i,3).toString()),"Laborat"
                                        });
                                    }
                                }
                            }else{
                                ...
                                Jasa_Menejemen_Laborat_Ralan=Jasa_Menejemen_Laborat_Ralan+Double.parseDouble(tbDetailLaboratBayar.getValueAt(i,10).toString());
                                tabModeBilling.addRow(new Object[]{
                                    "",tbDetailLaboratBayar.getValueAt(i,2).toString(),":",
                                    Double.parseDouble(tbDetailLaboratBayar.getValueAt(i,3).toString()),1,
                                    Double.parseDouble(tbDetailLaboratBayar.getValueAt(i,3).toString()),"Laborat"
                                });
                            }                                
                    ...
                    //Tambahan Untuk Cetak Ulang Nota Obat
                    for(i=0;i<tbObatBayar.getRowCount();i++){
                    ...
                    for(i=0;i<tbObatBayar.getRowCount();i++){
                        if(tbObatBayar.getValueAt(i,0).toString().equals("true")){
                            ...
                            subttl=subttl+Double.parseDouble(tbObatBayar.getValueAt(i,4).toString());
                            tabModeBilling.addRow(new Object[]{
                                "",tbObatBayar.getValueAt(i,2).toString(),":",
                                (Double.parseDouble(tbObatBayar.getValueAt(i,4).toString())/Double.parseDouble(tbObatBayar.getValueAt(i,3).toString())),
                                Double.parseDouble(tbObatBayar.getValueAt(i,3).toString()),Double.parseDouble(tbObatBayar.getValueAt(i,4).toString()),"Obat"
                            });                          
                        }
                    }

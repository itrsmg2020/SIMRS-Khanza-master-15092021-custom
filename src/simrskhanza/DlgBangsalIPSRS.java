 ...
 * @author dosen
 */
public final class DlgBangsalIPSRS extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgBangsalIPSRS(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Ruangan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("ruangan","?,?,?","Kode Kamar",3,new String[]{TKd.getText(),TNm.getText(),"1"})==true){
                tampil();
                emptTeks();
            }else{
                TKd.requestFocus();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbBangsal.getRowCount();i++){ 
            if(tbBangsal.getValueAt(i,0).toString().equals("true")){
                Sequel.mengedit("ruangan","kd_ruangan='"+tbBangsal.getValueAt(i,1).toString()+"'","status='0'");
            }
        } 
        tampil();
        emptTeks();
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"kode ruangan");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"nama ruangan");
        }else{
            if(tbBangsal.getSelectedRow()>-1){
                Sequel.mengedit("ruangan","kd_ruangan=?","nm_ruangan=?,kd_ruangan=?",3,new String[]{TNm.getText(),TKd.getText(),tbBangsal.getValueAt(tbBangsal.getSelectedRow(), 1).toString()});
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgBangsalIPSRS dialog = new DlgBangsalIPSRS(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select * from ruangan where status='1' and kd_ruangan like ? "+
                    "or status='1' and nm_ruangan like ? order by kd_ruangan");
            try {
    ...
    public void emptTeks() {
        ...
        TCari.setText("");
        TKd.requestFocus();
        Valid.autoNomer(" ruangan ","R",4,TKd);
    }
